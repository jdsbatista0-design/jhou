...
export function CentralProvider({ children, userId }: { children: React.ReactNode; userId: string }) {
  ...
  const ctxValue = useMemo<CentralContextType>(() => ({
    ...
    recurrences, recurrenceExceptions, addRecurrence, updateRecurrence, deleteRecurrence, deleteRecurringItem,
    setOccurrenceDone, cancelOccurrence, endRecurrenceFrom,
    dailyPriorities, setPriority, removePriority, markPriorityDone,
    settings, updateSettings,
  }), [
    loading, inbox, items, memories, events, agendaEntries, recurrences, recurrenceExceptions, dailyPriorities, settings,
